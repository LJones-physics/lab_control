...
Public Class AlpTest
    Private Function AlpErrorString(ByVal nRet As Int32) As String
        ...
        Select Case nRet
			...
			Case AlpReturnCodes.ALP_DRIVER_VERSION
				AlpErrorString = "ALP_DRIVER_VERSION"
			Case AlpReturnCodes.ALP_SDRAM_INIT
				AlpErrorString = "ALP_SDRAM_INIT"
			Case Else
    ...
    Private Sub Alloc_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Alloc.Click
		...
		If (AlpReturnCodes.ALP_OK = AlpDevInquire(m_AlpDeviceId, AlpDevTypes.ALP_DEV_DISPLAY_WIDTH, m_nSizeX) _
		 And AlpReturnCodes.ALP_OK = AlpDevInquire(m_AlpDeviceId, AlpDevTypes.ALP_DEV_DISPLAY_HEIGHT, m_nSizeY)) Then
			' Ok, DMD pixel count has been returned by ALP API
		Else
			' Fall-Back: Inquire the DMD type in order to retrieve data size information
